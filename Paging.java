 ...
 * @author Harita Reddy
 */
public class Paging extends javax.swing.JFrame {

    /**
     * Creates new form Paging
     */
    public Paging() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("FIFO Replacement and Belady's Anamoly");

        jPanel1.setBackground(new java.awt.Color(255, 204, 0));

        jTextArea3.setColumns(20);
        jTextArea3.setRows(5);
        jTextArea3.setText("Page Replacement\nAlgorithms are \nrequired to decide\nwhich frame to\nreplace when a \nrequired page has\nto be brought into\nthe memory.");
        ...
        jTextArea2.setText("Logically, page\nfaults should \ndecrease with \nincrease in number\nof frames. But this\nis not always the\ncase in FIFO. This\nis called Belady's\nanamoly.");
   ...
   // public static void main(String args[]) {
     ...
     /*   try {
            ...
            java.util.logging.Logger.getLogger(Paging.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
